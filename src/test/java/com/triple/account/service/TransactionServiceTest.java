...
import com.triple.account.domain.Transaction;
import com.triple.account.dto.TransactionDto;
...
import com.triple.account.repository.TransactionRepository;
...
class TransactionServiceTest {
    ...
    void exceedAmount_UseBalance() {
        ...
        Assertions.assertEquals(ErrorCode.AMOUNT_EXCEED_BALANCE, exception.getErrorCode());
    ...
    void successCancelBalance() {
        ...
        Assertions.assertEquals(TransactionResultType.S, transactionDto.getTransactionResultType());
        Assertions.assertEquals(TransactionType.CANCEL, transactionDto.getTransactionType());
    ...
    void cancelTransaction_TransactionNotFound() {
        ...
        //then
        Assertions.assertEquals(ErrorCode.TRANSACTION_NOT_FOUND, exception.getErrorCode());
    }
    ...
    void cancelTransaction_TransactionAccountUnMatch() {
        ...
        //then
        Assertions.assertEquals(ErrorCode.TRANSACTION_ACCOUNT_UN_MATCH, exception.getErrorCode());
    }
    ...
    void cancelTransaction_CancelMustFully() {
        ...
        //then
        Assertions.assertEquals(ErrorCode.CANCEL_MUST_FULLY, exception.getErrorCode());
    }
    ...
    void cancelTransaction_TooOldOrder() {
        ...
        //then
        Assertions.assertEquals(ErrorCode.TOO_OLD_ORDER_TO_CANCEL, exception.getErrorCode());
    }
